...
/// @DnDVersion : 1
/// @DnDHash : 49027643
/// @DnDArgument : "code" "/// @description Execute Code$(13_10)if (facingLeft == 1) {$(13_10)	sprite_index = gavinForwardLeft;$(13_10)} else if (facingRight == 1) {$(13_10)	sprite_index = gavinForwardRight;$(13_10)}$(13_10)if (y <= 650) {$(13_10)target_y += 3;	$(13_10)if((image_xscale <= 1.1) && (image_yscale <= 1.1)) {$(13_10)image_xscale += 0.007;$(13_10)image_yscale += 0.007;$(13_10)}$(13_10)}"
